function fetchOutstandingDays(leaveTypeId) {
    ...
    if (leaveTypeId) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "get_loan_number",
            data: {leaveTypeId:leaveTypeId, _token: token },
            success: function(data) {
                document.getElementById('outstanding_days').value = data.outstanding_days;

            }
        });
    } else {
        document.getElementById('outstanding_days').value = 0;
    }
}
